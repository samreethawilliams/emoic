...
const Bg = (props) => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500" {...props}>
    <Defs>
      <LinearGradient id="b" x1="0" y1="750" x2="1550" y2="750">
        <Stop offset="0" stopColor="#9fc5cd" />
    ...
    <G>
      <G>
        <Circle fill="url(#b)" r="3000" />
        <G opacity="0.5">
          <Circle fill="url(#b)" r="2000" />
          <Circle fill="url(#b)" r="1800" />
          <Circle fill="url(#b)" r="1700" />
          <Circle fill="url(#b)" r="1651" />
          <Circle fill="url(#b)" r="1450" />
          <Circle fill="url(#b)" r="1250" />
          <Circle fill="url(#b)" r="1175" />
          <Circle fill="url(#b)" r="900" />
          <Circle fill="url(#b)" r="750" />
          <Circle fill="url(#b)" r="500" />
          <Circle fill="url(#b)" r="380" />
          <Circle fill="url(#b)" r="250" />
        </G>
        <G>
        ...
        <Circle fillOpacity="0" fill="url(#b)" r="3000" />
      </G>
    </G>
  </Svg>
);
